              ...
              <div class="col-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="https://www.bmkg.go.id/asset/img/logo/logo-bmkg.svg" width=75px>
                  </div>
                  <hr>
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Dashboard <?=$name_web;?></h1>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <a class="small" href="<?=$main_url;?>"><i class="fas fa-globe"></i> Back To Home</a>
                    </div>
                  </div>
                </div>
              </div>
