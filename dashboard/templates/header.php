...
<head>
  ...
  <link href="<?=$main_url;?>asset/css/summernote.min.css" rel="stylesheet">
    ...
    <ul class="navbar-nav  sidebar sidebar-success " id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
        <div class="sidebar-brand-icon rotate-n-15">
          <img src="https://www.bmkg.go.id/asset/img/logo/logo-bmkg.png" width="50" height="50">
        </div>
        <div class="sidebar-brand-text mx-3">BMKG TUBAN</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="posting.php">
            <i class="fas fa-fw fas fa-sticky-note"></i>
            <span>Posting</span> </a>
          </li>
