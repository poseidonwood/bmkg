    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Trial Remote Mesin</h6>
        </div>
        ...
        <div class="card-body">
          ...
          <form action="" method="post">
            ...
            <br>
            <center><button class="btn btn-success"> ON </button>&nbsp;<button class="btn btn-primary"> OFF </button></center>
            <br>
            <br>
          </form>
        </div>
...
<footer class="sticky-footer bg-white">
  <div class="container my-auto">
    <div class="copyright text-center my-auto">
      <span>Copyright &copy; <a href="https://web.facebook.com/menz.pedia.96/">SKMI</a></span>
    </div>
  </div>
</footer>
<!-- End of Footer -->
